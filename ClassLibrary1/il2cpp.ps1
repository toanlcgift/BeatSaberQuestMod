...
$UnityPath = "C:\Program Files\Unity\Editor\Data"
...
$actualUnityVersion = [System.Diagnostics.FileVersionInfo]::GetVersionInfo("C:\Program Files\Unity\Editor\Unity.exe").FileVersion
...
$AndroidNDK = 'C:\Android\android-sdk\ndk\19.0.5232133'
...
# Workspace paths
$src = "C:\Repo\BeatSaberQuestMod\ClassLibrary1"
$asm = "C:\Repo\BeatSaberQuestMod\ClassLibrary1\Libs2"
$cpp = "C:\Repo\BeatSaberQuestMod\ClassLibrary1\Cpp"
$bin = "C:\Repo\BeatSaberQuestMod\ClassLibrary1\bin\Debug"
...
gci "$src/*" -Include $cs | % {
	...
	& $csc "/r:Libs/UnityEngine.dll" "/r:Libs/UnityEngine.CoreModule.dll" "/t:library" "/nologo" "/unsafe" "/out:$asm/$($_.BaseName).dll" "$_"
